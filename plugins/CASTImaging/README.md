...
| Skill | Description |
|-------|-------------|
| `impact-analysis` | Evaluate the scope and risk of code changes across your application landscape |

## Commands

| Command | Description |
|---------|-------------|
| `/CASTImaging:impact-analysis [application] [object_name]` | Run impact analysis on a code object |
